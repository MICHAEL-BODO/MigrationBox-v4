...
export interface DatabaseAdapter {
    ...
    transactWriteItems(transactions: Array<{
        table: string;
...
export interface IAMAdapter {
    ...
    validatePermissions(requiredPermissions: string[]): Promise<{
        granted: string[];
        denied: string[];
    }>;
    createServiceAccount(name: string, policies: string[]): Promise<{
        id: string;
    ...
    createRole(roleName: string, assumeRolePolicy: string, policies: string[]): Promise<{
        roleArn: string;
    }>;
...
export interface ComputeAdapter {
    invokeFunction(functionName: string, payload: Record<string, any>): Promise<{
        statusCode: number;
        body: any;
    }>;
...
export interface MonitoringAdapter {
    ...
    getMetricStatistics(metricName: string, startTime: Date, endTime: Date, period: number, statistics: string[]): Promise<Array<{
        timestamp: Date;
        value: number;
    }>>;
    ...
    describeAlarm(alarmName: string): Promise<Alarm & {
